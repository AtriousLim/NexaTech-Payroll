            ...
            <div class="mt-6 rounded-[2rem] border border-slate-200 bg-slate-50 p-6 shadow-sm">
                <div class="flex flex-wrap items-center justify-between gap-3">
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        <a href="{{ route('admin.employees.edit', ['employee' => $employeeDetail->id]) }}" class="inline-flex items-center rounded-full bg-blue-900 px-4 py-2 text-sm font-semibold text-white transition hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                            Edit details
                        </a>
                    </div>
                </div>
